...
class SchedulerGUI:
    ...
    def build_about(self):
        ...
        contributors = [
            "AKSHAT PRATAP SINGH: Implemented scheduling algorithms",
            "AKSHAT PRATAP SINGH A && ABHIK MAHAJAN: Developed the GUI frontend",
            "UTTAM KUMAR: Created visualization and utilities"
        ]
        for contributor in contributors:
            ttk.Label(about_frame, text=contributor, style="Modern.TLabel").pack(anchor="w", pady=1)

        # Additional Info
        ttk.Label(about_frame, text="Date: April 15, 2025", style="Modern.TLabel").pack(pady=2)
